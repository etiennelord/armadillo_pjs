  <div data-role="dialog" id="dnapars"  style="padding:0px" data-overlay-theme="d" data-theme="b" style="max-width:600px;background-color:transparent; background: transparent !importantl; margin:20px auto;
position: relative;" class="ui-corner-all" data-close-btn="none">		
					<div data-role="header" data-theme="b" >
						<h2>DNAPars (Phylip)</h1>
		...
		<li data-role="list-divider">Compute options</li>				
			...
			<tr>
				...
				<tr>
					...
					<td ><select name='N' id="N" data-mini="true" data-inline="true">
					<option value='yes'>Yes, count only transversions</option>
					<option value='no' selected >No, count all steps</option>				
					</td>
				</tr>
