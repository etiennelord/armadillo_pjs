		...
		<div data-role="dialog" id="hgt32"  style="padding:0px" data-overlay-theme="d" data-theme="b" style="max-width:600px;background-color:transparent; background: transparent;!important" class="ui-corner-all" data-close-btn="none">		
		<form>
		...
		<li data-role="list-divider">Scenario</li>				
			<table width='100%'>									
				<tr>
